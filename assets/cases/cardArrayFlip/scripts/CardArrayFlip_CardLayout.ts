import CardArrayFlip_Card from './CardArrayFlip_Card';

const { ccclass, property, executeInEditMode } = cc._decorator;

@ccclass
@executeInEditMode
export default class CardArrayFlip_Layout extends cc.Component {
    ...
    /** 卡片组件 */
    protected cards: CardArrayFlip_Card[] = null;
    ...
    protected onChildChange() {
        // 重新获取组件
        this.cards = this.getComponentsInChildren(CardArrayFlip_Card);
        // 更新 k 值
        this.updateKValue();
        // 更新布局
        this.updateLayout();
