  ...
  Mosaic: [ function(require, module, exports) {
    ...
    var Mosaic = function(_super) {
      ...
      function Mosaic() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this._effect = null;
        _this._tileSize = new cc.Vec2(5, 5);
        _this.sprite = null;
        _this.material = null;
        return _this;
      }
      ...
      Mosaic.prototype.getNodeSize = function() {
        return cc.v2(this.node.width, this.node.height);
      };
      ...
      __decorate([ property ], Mosaic.prototype, "_tileSize", void 0);
      __decorate([ property({
        tooltip: false
      }) ], Mosaic.prototype, "tileSize", null);
