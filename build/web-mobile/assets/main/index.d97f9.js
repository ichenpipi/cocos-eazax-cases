window.__require = function e(t, n, r) {
  ...
  CardArray_CardLayout: [ function(require, module, exports) {
    ...
    var CardArray_Layout = function(_super) {
      ...
      CardArray_Layout.prototype.update = function(dt) {
      ...
      CardArray_Layout.prototype.updateLayout = function() {
        var nodes = this.node.children, radius = this._radius;
        for (var i = 0, l = nodes.length; i < l; i++) {
          var node = nodes[i], radian = Math.PI / 180 * (node.eulerAngles.y - 90);
  ...
  CardArray_Card: [ function(require, module, exports) {
    ...
    var CardArray_Card = function(_super) {
      ...
      CardArray_Card.prototype.updateDisplay = function() {
        var front = this.isFacingScreen();
        this.front.active = front;
        this.back.active = !front;
      };
      CardArray_Card.prototype.isFacingScreen = function() {
        var node = this.node, container = node.getParent(), worldPos = container.convertToWorldSpaceAR(node.position), localPos = container.parent.convertToNodeSpaceAR(worldPos);
        return localPos.z > 0;
      };
      ...
      CardArray_Card = __decorate([ ccclass ], CardArray_Card);
  ...
  CardArray_Content: [ function(require, module, exports) {
    ...
    var CardArray_Content = function(_super) {
      ...
      CardArray_Content.prototype.rotateForever = function() {
        var node = this.cardContainer;
        cc.tween(node).by(2, {
          eulerAngles: cc.v3(0, 90, 0)
        }).repeatForever().start();
      };
      __decorate([ property(cc.Node) ], CardArray_Content.prototype, "cardContainer", void 0);
  ...
  CaseManager: [ function(require, module, exports) {
    ...
    var CaseManager = function() {
      ...
      CaseManager.hasCase = function(caseName) {
        return null != this.getCaseInfo(caseName);
      };
  ...
  FlipCard: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "3cf8arMOblOeL4UxCUU8QcT", "FlipCard");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var FlipCard = function(_super) {
      ...
      FlipCard.prototype.onLoad = function() {
        this.init();
        this.registerEvent();
      };
      FlipCard.prototype.start = function() {
        this.reset();
      };
      FlipCard.prototype.onDestroy = function() {
        this.unregisterEvent();
      };
      FlipCard.prototype.registerEvent = function() {
        this.flipBtn.on(cc.Node.EventType.TOUCH_END, this.onFlipBtnClick, this);
      };
      FlipCard.prototype.unregisterEvent = function() {
        this.flipBtn.targetOff(this);
      };
      FlipCard.prototype.init = function() {
      ...
      FlipCard.prototype.onFlipBtnClick = function() {
      ...
      FlipCard.prototype.setButtonState = function(interactable) {
        this.button.interactable = interactable;
        this.flipBtn.color = interactable ? cc.Color.WHITE : cc.Color.GRAY;
      };
      __decorate([ property(cc.Node) ], FlipCard.prototype, "card", void 0);
      __decorate([ property(cc.Node) ], FlipCard.prototype, "flipBtn", void 0);
      FlipCard = __decorate([ ccclass ], FlipCard);
      return FlipCard;
    }(cc.Component);
  ...
  FrameLoading: [ function(require, module, exports) {
    ...
    var FrameLoading = function(_super) {
      ...
      __decorate([ property(cc.Node) ], FrameLoading.prototype, "item", void 0);
  ...
  Home: [ function(require, module, exports) {
    ...
    var Home = function(_super) {
      ...
      Home.prototype.detectCaseParam = function() {
        ...
        caseName && CaseManager_1.default.hasCase(caseName) && CaseManager_1.default.goCase(caseName);
      };
  ...
  PopupBase_dev: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2280ecWmd5KJqbVEnDp780P", "PopupBase_dev");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var PopupBase_dev = function(_super) {
      __extends(PopupBase_dev, _super);
      function PopupBase_dev() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
      ...
      PopupBase_dev.prototype.onShow = function() {};
      PopupBase_dev.prototype.onHide = function(hidByForce) {
        void 0 === hidByForce && (hidByForce = false);
      };
      PopupBase_dev.prototype.show = function(options, time) {
        var _this = this;
      ...
      PopupBase_dev.prototype.hide = function(time, hidByForce) {
        var _this = this;
        void 0 === time && (time = this.animTime);
        void 0 === hidByForce && (hidByForce = false);
        if (0 === time) {
      ...
      PopupBase_dev.prototype.init = function(options) {};
      PopupBase_dev.prototype.updateDisplay = function(options) {};
      PopupBase_dev.prototype.setFinishCallback = function(callback) {
        this.finishCallback = callback;
      };
      __decorate([ property({
        type: cc.Node,
        tooltip: false
      }) ], PopupBase_dev.prototype, "background", void 0);
      __decorate([ property({
        type: cc.Node,
        tooltip: false
      }) ], PopupBase_dev.prototype, "main", void 0);
      PopupBase_dev = __decorate([ ccclass ], PopupBase_dev);
      return PopupBase_dev;
    }(cc.Component);
    exports.default = PopupBase_dev;
    cc._RF.pop();
  }, {} ],
  PopupBase: [ function(require, module, exports) {
    ...
    var PopupBase = function(_super) {
      ...
      PopupBase.prototype.onHide = function(force) {
      ...
      PopupBase.prototype.show = function(options, time) {
        ...
        return new Promise(function(res) {
          ...
          cc.tween(background).to(.8 * time, {
            opacity: 200
          }).start();
          cc.tween(main).to(time, {
            scale: 1,
            opacity: 255
          }, {
            easing: "backOut"
      ...
      PopupBase.prototype.hide = function(time, force) {
        var _this = this;
        void 0 === time && (time = this.animTime);
        void 0 === force && (force = false);
        return new Promise(function(res) {
          if (0 === time) {
            _this.node.active = false;
            _this.onHide && _this.onHide(force);
            res();
            _this.finishCallback && _this.finishCallback(force);
            return;
          }
          ...
          if (!blocker) {
            ...
            blocker.setParent(_this.node);
            blocker.setContentSize(_this.node.getContentSize());
          }
          blocker.active = true;
          cc.tween(_this.background).delay(.2 * time).to(.8 * time, {
            opacity: 0
          }).start();
          cc.tween(_this.main).to(time, {
            scale: .5,
            opacity: 0
          }, {
            easing: "backIn"
  ...
  PopupManager: [ function(require, module, exports) {
    ...
    var PopupManager = function() {
      ...
      PopupManager.parseParams = function(params) {
        void 0 == params && (params = Object.create(null));
        void 0 == params.mode && (params.mode = PopupCacheMode.Normal);
        void 0 == params.priority && (params.priority = false);
        return params;
      };
...
}, {}, [ "CardArray_Card", "CardArray_CardLayout", "CardArray_Content", "CardArray_UI", "FlipCard", "FrameLoading", "NewUserGuide", "PopupTest", "TestPopup", "RadarChartController", "SineWaveController", "BackgroundFitter", "Counter", "LongPress", "Marquee", "RadarChart", "RotateAround", "RunInBackground", "ScreenAdapter", "Subtitle", "TouchBlocker", "TouchBlocker2", "ColorBrush", "GaussianBlur", "HollowOut", "SineWave", "LocalizationBase", "LocalizationLabelString", "LocalizationSpriteFrame", "ConfirmPopup", "PopupBase", "PopupBase_dev", "GradientColor", "BounceMoveTween", "BounceScaleTween", "JellyTween", "Events", "AudioPlayer", "EventManager", "InstanceEvent", "NetworkManager", "PoolManager", "PopupManager", "PopupManager_dev", "ResourceManager", "SceneNavigator", "eazax", "extension", "EditorAsset", "ArrayUtil", "BrowserUtil", "DebugUtil", "DeviceUtil", "ImageUtil", "MathUtil", "NodeUtil", "ObjectUtil", "PromiseUtil", "RegexUtil", "StorageUtil", "TimeUtil", "TweenUtil", "CaseManager", "ClickToLoadUrl", "ClickToShowResPopup", "CommonUI", "LoadingTip", "ResPopup", "ResPopupItem", "ResPopupItemInfo", "Constants", "CustomEvents", "Home", "Home_Content", "Home_UI", "Home_CaseBtn", "Home_CaseList" ]);