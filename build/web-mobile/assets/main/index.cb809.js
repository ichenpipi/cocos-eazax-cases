window.__require = function e(t, n, r) {
  ...
  RemoteSpine: [ function(require, module, exports) {
    ...
    var RemoteAsset_1 = require("../../../eazax-ccc/components/remote/RemoteAsset");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property, executeInEditMode = _a.executeInEditMode;
    ...
    "../../../eazax-ccc/components/remote/RemoteAsset": "RemoteAsset"
  } ],
...
}, {}, [ "AfterEffect", "Case_AfterEffect_Controller", "Case_ArcProgressBar", "CardArray_Card", "CardArray_CardLayout", "Case_CardArray_Controller", "CardArrayFlip_Card", "CardArrayFlip_CardLayout", "CardArrayFlip_FrontCard2D", "CardArrayFlip_FrontCard3D", "CardArrayFlip_FrontCardBase", "Case_CardArrayFlip", "Case_CardFlip", "Case_FrameLoading", "Case_NewUserGuide", "Case_PopupTest", "TestPopup", "Case_RadarChart", "Case_RemoteAsset", "Case_SineWave_Controller", "ArcProgressBar", "BackgroundFitter", "Counter", "LongPress", "Marquee", "RotateAround", "RunInBackground", "ScreenAdapter", "Subtitle", "TouchBlocker", "TouchBlocker2", "RadarChart", "ColorBrush", "GaussianBlur", "HollowOut", "Mosaic", "SineWave", "LocalizationBase", "LocalizationLabelString", "LocalizationSpriteFrame", "ConfirmPopup", "PopupBase", "RemoteAsset", "RemoteLoader", "RemoteTexture", "GradientColor", "BounceMoveTween", "BounceScaleTween", "JellyTween", "AudioPlayer", "EventManager", "InstanceEvent", "PopupManager", "SceneNavigator", "eazax", "extension", "EditorAsset", "ArrayUtil", "BrowserUtil", "DebugUtil", "DeviceUtil", "ImageUtil", "MathUtil", "NodeUtil", "ObjectUtil", "PromiseUtil", "RegexUtil", "StorageUtil", "TimeUtil", "TweenUtil", "CaseList", "CaseManager", "CaseLoading", "ClickToLoadUrl", "ClickToShowResPopup", "CommonUI", "LoadingTip", "Toast", "ResPopup", "ResPopupItem", "ResPopupItemInfo", "Constants", "CustomEvents", "Home", "Home_Content", "Home_UI", "Home_CaseBtn", "Home_CaseList", "TestCard", "Test_3DNode", "Test_NodeOrder", "RemoteSpine", "NetworkManager", "PoolManager", "ResourceManager" ]);