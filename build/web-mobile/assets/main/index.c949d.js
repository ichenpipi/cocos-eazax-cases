          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              Toast_1.default.show("\ud83c\udf00 \u6b63\u5728\u52a0\u8f7d\u8fdc\u7a0b\u56fe\u50cf...");
              url = editorBox.string;
  ...
  RemoteLoader: [ function(require, module, exports) {
    ...
    var RemoteLoader = function() {
      ...
      RemoteLoader.loadTexture = function(url, callback) {
        return new Promise(function(res) {
          cc.assetManager.loadRemote(url, function(_error, _texture) {
            if (_error) {
  ...
  RemoteTexture: [ function(require, module, exports) {
    ...
    var RemoteTexture = function(_super) {
      ...
      RemoteTexture.prototype.load = function(url) {
        ...
        return __awaiter(this, void 0, void 0, function() {
          var texture, loadCount, maxLoadTimes;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              texture = null, loadCount = 0, maxLoadTimes = this.retryTimes + 1;
              _a.label = 1;
